 ...
 * @param {Object} [TIMEOUTS] The instance of the queue registry.
 * @return {Promise}
 */
function wait(file, time, TIMEOUTS = {}) {
    if (TIMEOUTS[file]) {
...
module.exports = (app, files, callback, options = {}) => {
     ...
     */
    const HASHES = {};
    return chokidar.watch(files, options, TIMEOUTS)
        .on('all', (event, p) => {
            // Get absolute path.
