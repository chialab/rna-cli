...
class PackageManager {
     ...
     */
    async install() {
        return await exec(BIN, ['--cwd', this.cwd, 'install', '-W']);
    }
    ...
    async add(...packages) {
        ...
        return await exec(BIN, ['--cwd', this.cwd, 'add', ...packages, '-W']);
    }
    ...
    async dev(...packages) {
        ...
        return await exec(BIN, ['--cwd', this.cwd, 'add', ...packages, '--dev', '-W']);
    }
    ...
    async remove(...packages) {
        ...
        return await exec(BIN, ['--cwd', this.cwd, 'remove', ...packages, '-W']);
    }
