...
class NavigatorDirectory extends NavigatorEntry {
    ...
    entry(file) {
        return new NavigatorEntry(path.resolve(this.path, file), this.cwd);
    }

    file(file) {
        return new NavigatorFile(path.resolve(this.path, file), this.cwd);
    }

    directory(directory) {
        return new NavigatorDirectory(path.resolve(this.path, directory), this.cwd);
    }
}
