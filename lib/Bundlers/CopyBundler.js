...
class CopyBundler extends Bundler {
    ...
    async write() {
        ...
        this.emit(CopyBundler.WRITE_START_EVENT);
        await this.result.copy(output);
        this.emit(CopyBundler.WRITE_PROGRESS_EVENT, output);
        this.emit(CopyBundler.WRITE_END_EVENT);
        await super.write();
        return output;
    }
}
