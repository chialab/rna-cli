...
class StyleBundler extends Bundler {
    ...
    async build(...invalidate) {
        ...
        this.emit(StyleBundler.START_EVENT, input, code, invalidate);
        ...
        try {
            ...
            if (this.linter && (this.linter.hasErrors() || this.linter.hasWarnings())) {
                this.emit(StyleBundler.LINT_EVENT, this.linter.report());
            }

            this.emit(StyleBundler.END_EVENT);
    ...
    async write() {
        ...
        this.emit(StyleBundler.WRITE_EVENT, output);
        return output;
    }
