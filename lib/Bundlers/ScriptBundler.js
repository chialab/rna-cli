...
class ScriptBundler extends Bundler {
    ...
    async setup(options = {}) {
        ...
        this.options.format = this.options.format || 'umd';
        this.options.assetFileNames = this.options.assetFileNames || 'assets/[name][extname]';
    ...
    async build(...invalidate) {
        ...
        const { input, output, code, map, typings, format } = this.options;
