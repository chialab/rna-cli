...
const dts = require('./plugins/rollup-plugin-dts/rollup-plugin-dts');
...
class ScriptBundler extends Bundler {
    ...
    async setup(options = {}) {
        ...
        let { input, output, code, root, format, typings, coverage, jsx } = options;
        if (!input && !code) {
        ...
        await super.setup({
            ...
            plugins: [
                ...
                esbuild({
                    ...
                    exclude: /node_modules\/@babel\/runtime\/helpers/,
                ...
                babel({
                    ...
                    plugins: [
                        ...
                        jsx !== false && [require('babel-plugin-htm'), {
                            pragma: jsx && jsx.pragma || 'IDOM.h',
                            import: {
                                module: jsx && jsx.module || '@dnajs/idom',
                                export: jsx && jsx.pragmaDefault ? 'default' : undefined,
                            },
                        }],
                        jsx !== false && [require('./plugins/babel-plugin-jsx/babel-plugin-jsx'), {
                            pragma: jsx && jsx.pragma || 'IDOM.h',
                            pragmaFrag: jsx && jsx.pragmaFrag,
                            import: jsx && jsx.module || '@dnajs/idom',
    ...
    async build(...invalidate) {
        ...
        const { input, output, root, code, map, format, cache, typings, vendors } = this.options;
