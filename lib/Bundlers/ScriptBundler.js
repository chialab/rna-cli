...
class ScriptBundler extends Bundler {
    ...
    async setup(options = {}) {
            ...
            babelConfig = {
                ...
                presets: [
                    [require('@chialab/babel-preset'), {
                        ...
                        coverageExclude: [
                            ...(this.project.workspaces ? this.project.workspaces.map((ws) => ws.directory('node_modules').localPath) : [this.project.directory('node_modules').localPath]),
                            (this.project.directories.test || this.project.directory('test')).localPath,
                        ],
        ...
        let plugins = [
            ...
            html(this.app, this.project, options)({
                exclude: [],
                include: [
                    /\.(html|htm)$/,
                ],
            ...
            postcss(this.app, this.project)({
                ...
                output: output && output.basename ? output.parent : output,
            }),
        ...
        let external = (id) => {
            ...
            if (format !== 'umd' && !bundle && !path.isAbsolute(id) && !id.match(/\.\.?\//)) {
