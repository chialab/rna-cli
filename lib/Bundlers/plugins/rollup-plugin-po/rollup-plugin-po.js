...
module.exports = function po(opts = {}) {
    ...
    const plugin = {
        ...
        async load(id) {
            ...
            translation.data = Object.assign({}, JSON.parse(json), translation.data);

            // just export the asset url
            return `export default import.meta.ROLLUP_FILE_URL_${translation.asset};`;
        },
        ...
        buildEnd() {
            ...
            for (let translationId in this.translations) {
                ...
                this.setAssetSource(translation.asset, JSON.stringify(translation.data, null, 2));
            }
        },
    };
