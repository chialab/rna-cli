...
class RollupBundle extends Bundle {
    /**
     * @inheritdoc
     */
    constructor(input, output, rollupBundle) {
        super(input, output);
        this.result = rollupBundle;
    }
...
module.exports = class Rollup {
    ...
    async build(options = {}) {
        ...
        return new RollupBundle(options.input, options.output, bundle);
    }
