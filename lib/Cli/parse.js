 ...
 * @param {string} pipeSep The pipeline seprator char.
 * @return {Array<Object>} An array of command options.
 */
module.exports = function parse(argv, pipeSep = '+') {
    /**
    ...
    function openOption(opt) {
        ...
        if (Object.prototype.hasOwnProperty.call(lastPipe, name)) {
