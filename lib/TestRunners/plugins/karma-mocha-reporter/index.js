...
function MochaReporter(baseReporterDecorator, formatError, config) {
    ...
    let divider = Object.prototype.hasOwnProperty.call(config.mochaReporter, 'divider') ? config.mochaReporter.divider : '=';
    ...
    function specComplete(browser, result) {
        ...
        path.reduce((suite, description, depth) => {
            ...
            if (Object.prototype.hasOwnProperty.call(suite, description) && suite[description].type === 'it' && self.numberOfBrowsers === 1) {
                item = {};
                description += ' ';
            } else {
